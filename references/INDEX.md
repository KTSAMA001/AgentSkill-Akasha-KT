...
| [li-comm-polling-to-event-driven.md](../data/li-comm-polling-to-event-driven.md) | #openclaw #macos #docker #experience #architecture | ✅ 已验证 | 双璃通信从轮询到事件驱动优化（token 消耗降低 96%） |
