...
| [unity6-migration-guide.md](../data/unity6-migration-guide.md) | #unity #urp #shader #knowledge #reference #rendering #dots | ⚠️ 待验证 | Unity 6 (6000.x) 迁移完整指南：Breaking Changes、新功能、已知问题、TA 影响评估、5 阶段迁移路线图 |
