...
**状态**：⚠️ 待验证
**可信度**：⭐⭐⭐
**适用版本**：3ds Max 2015+, Unity 2020+

### 概要

美术在做模型资产时法线正常（硬边效果），但动画绑定后法线被打乱。原因是 3ds Max Skin 修改器的位置和 FBX 导出设置问题。
...
- [animation-retarget-technology-unity.md](./animation-retarget-technology-unity.md) - 动画重定向技术
