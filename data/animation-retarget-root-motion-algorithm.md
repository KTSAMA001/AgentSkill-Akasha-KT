...
**标签**：#unity #animation #math #root-motion #animation-retarget #knowledge
**来源**：专题报告
**收录日期**：2026-02-13
**来源日期**：2026-02-13
**更新日期**：2026-02-13
...
- [Unity 动画与脚本开发核心知识清单](./unity-animation-scripting-notes.md) - Root Motion API 详解
- [动画重定向技术分析和 Unity 中的应用](./animation-retarget-technology-unity.md) - 骨骼映射与参考姿势原理
