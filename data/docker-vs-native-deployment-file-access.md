...
**标签**：#docker #deployment #tools #experience #ai
**来源**：实战讨论总结 + 社区调研
**收录日期**：2026-02-21
**来源日期**：2026-02-21
**更新日期**：2026-03-04
...
- [docker-container-git-auth-persist.md](./docker-container-git-auth-persist.md) - Docker 容器重建后 Git 认证持久化
- [docker-git-credential-persist.md](./docker-git-credential-persist.md) - Docker 容器内 Git PAT 凭据持久化
