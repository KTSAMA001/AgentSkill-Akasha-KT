...
**操作**：
1. 判断为 Unity C# 相关 → 读取 `~/.copilot/experiences/unity/csharp.md`
2. 搜索关键词"协程"、"yield"、"等待"
3. 找到相关记录 → 展示给用户
...
**操作**：
1. 判断为 Unity 相关 → 读取 `~/.copilot/experiences/unity/csharp.md`
...
3. 创建独立文档：`~/.copilot/experiences/unity/docs/VR_Variant_Collector_Architecture.md`
